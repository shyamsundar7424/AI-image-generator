...
const TextToImageGenerator = () => {
  ...
  const generateImage = async () => {
    ...
    const options = {
      ...
      headers: {
        'x-rapidapi-key': '0ef185e742msh2636f6dbc0e2e28p191d95jsneb1bd21e1f8c',
  ...
  useEffect(() => {
    ...
    script.src = "//www.highperformanceformat.com/8f2a228633075a1ac584143b940085e6/invoke.js"; // Ad script
    ...
    adOptions.innerHTML = `
      atOptions = {
        'key' : '8f2a228633075a1ac584143b940085e6',
        'format' : 'iframe',
        'height' : 300,
        'width' : 160,
        'params' : {}
    ...
    `;
    document.body.appendChild(adOptions);

    // Cleanup function to remove the script when the component unmounts
    return () => {
      document.body.removeChild(script);
      document.body.removeChild(adOptions);
    };
